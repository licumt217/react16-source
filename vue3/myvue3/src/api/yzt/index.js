 ...
 * @returns
 */
export function getIndirectMsg({ id }) {
    return request({
 ...
 * @returns
 */
export function indirectList({ id, yztName, startDate, endDate, start, limit, certImgStatus }) {
    return request({
 ...
 * @returns
 */
export function rechargeConfirm({ amount }) {
    return request({
 ...
 * @returns
 */
export function RechargeDetail({ start, limit }) {
    return request({
 ...
 * @returns
 */
export function getDailyDivideList({ divideState, start, limit, startDate, endDate }) {
    return request({
 ...
 * @returns
 */
export function getRelBusinessBySmId({ smid, start, limit }) {
    return request({
 ...
 * @returns
 */
export function openYztSettle({ parkId }) {
    return request({
 ...
 * @returns
 */
export function closeYztSettle({ parkId }) {
  return request({
 ...
 * @returns
 */
export function queryYztSettleState({ parkId }) {
    return request({
 ...
 * @returns
 */
export function manualRecharge({ amount }) {
    return request({
 ...
 * @returns
 */
export function getParkSettleOrder({ pmParkId, businessType, payState, startDate, endDate, start, limit }) {
    return request({
 ...
 * @returns
 */
export function selectParkSettleOrderExcel({ pmParkId, businessType, payState, startDate, endDate }) {
    return request({
 ...
 * @returns
 */
export function yztBatchRePay({ ids }) {
    return request({
 ...
 * @returns
 */
export function yztBatchReQuery({ ids }) {
    return request({

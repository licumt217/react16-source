...
exports.getPlateUrlOfLatestByName = exports.getPlateUrlOfHistoryFn = exports.getMonthHistoryUrl = exports.getWeekHistoryUrl = exports.getDayUrlOfHistoryByCodeFn = exports.getDayUrlOfLatestAll = void 0;
 ...
 * @returns
 */
function getDayUrlOfLatestAll(page, pageSize) {
...
exports.getDayUrlOfLatestAll = getDayUrlOfLatestAll;
/**
 ...
 * @returns
 */
function getDayUrlOfHistoryByCodeFn(startDate, endDate = "20500101") {
...
exports.getDayUrlOfHistoryByCodeFn = getDayUrlOfHistoryByCodeFn;
/**
 * 拉取给定股票code的周线线历史数据url
 * @param code
 * @returns
 */
function getWeekHistoryUrl(code) {
    const lmt = 120;
    const secid = getSecid(code);
    return (`http://3.push2his.eastmoney.com/api/qt/stock/kline/get?cb=jQuery351015441810346728446_1668152697971&` +
...
exports.getWeekHistoryUrl = getWeekHistoryUrl;
/**
 * 拉取给定股票code的月线历史数据url
 * @param code
 * @returns
 */
function getMonthHistoryUrl(code) {
    const lmt = 460;
    const secid = getSecid(code);
    const fqt = 1; //复权相关
    return (`http://29.push2his.eastmoney.com/api/qt/stock/kline/get?cb=jQuery112405439813560193669_1654140311512` +
...
exports.getMonthHistoryUrl = getMonthHistoryUrl;
function isShenZhengStock(code) {
 ...
 * @returns
 */
function getPlateUrlOfHistoryFn(plateBeginDate) {
    const UrlOfPlateMap = new Map()
        .set('cyb', `http://46.push2his.eastmoney.com/api/qt/stock/kline/get` +
        `?secid=0.399006` +
        ...
        `&_=1643355686402` +
        `&beg=${plateBeginDate}`)
        .set('shangzheng', `http://96.push2his.eastmoney.com/api/qt/stock/kline/get` +
        ...
        `&_=1643356019585` +
        `&beg=${plateBeginDate}`)
        .set('shenzheng', `http://91.push2his.eastmoney.com/api/qt/stock/kline/get` +
        `?ut=fa5fd1943c7b386f172d6893dbfba10b` +
        ...
        `&_=1643356101433` +
        `&beg=${plateBeginDate}`)
        .set('hs300', `http://79.push2his.eastmoney.com/api/qt/stock/kline/get` +
        `?ut=fa5fd1943c7b386f172d6893dbfba10b` +
        `&fields1=f1%2Cf2%2Cf3%2Cf4%2Cf5%2Cf6&fields2=f51%2Cf52%2Cf53%2Cf54%2Cf55%2Cf56%2Cf57%2Cf58%2Cf59%2Cf60%2Cf61&klt=101&fqt=1` +
        `&end=20500101` +
        ...
        `&_=1643356166728` +
        `&beg=${plateBeginDate}`)
        .set('sz50', `http://37.push2his.eastmoney.com/api/qt/stock/kline/get` +
        `?ut=fa5fd1943c7b386f172d6893dbfba10b` +
        `&fields1=f1%2Cf2%2Cf3%2Cf4%2Cf5%2Cf6&fields2=f51%2Cf52%2Cf53%2Cf54%2Cf55%2Cf56%2Cf57%2Cf58%2Cf59%2Cf60%2Cf61&klt=101&fqt=1` +
        `&end=20500101` +
        ...
        `&_=1643356217132` +
        `&beg=${plateBeginDate}`)
        .set('kcb', `http://38.push2his.eastmoney.com/api/qt/stock/kline/get` +
     ...
     */
    return function getPlateUrlOfHistoryByName(plateName) {
        return UrlOfPlateMap.get(plateName);
    };
}
exports.getPlateUrlOfHistoryFn = getPlateUrlOfHistoryFn;
/**
 * 根据板块名称返回获取板块最新数据的URL；只获取当天最新的一条数据
 * @param plateName
 * @returns
 */
function getPlateUrlOfLatestByName(plateName) {
    let url = '';
    const beginDate = DateUtil_1.default.getDateStrYYYYMMDD();
    switch (plateName) {
        case PlateNames_1.default.CYB:
            url =
                `http://46.push2his.eastmoney.com/api/qt/stock/kline/get` +
                    ...
                    `&beg=${beginDate}`;
            break;
        case PlateNames_1.default.SHANG_ZHENG:
            url =
                `http://96.push2his.eastmoney.com/api/qt/stock/kline/get` +
                    ...
                    `&beg=${beginDate}`;
            break;
        case PlateNames_1.default.SHEN_ZHENG:
            url =
                `http://91.push2his.eastmoney.com/api/qt/stock/kline/get` +
                    ...
                    `&beg=${beginDate}`;
            break;
        case PlateNames_1.default.HS300:
            url =
                `http://79.push2his.eastmoney.com/api/qt/stock/kline/get` +
                    ...
                    `&beg=${beginDate}`;
            break;
        case PlateNames_1.default.SZ50:
            url =
...
exports.getPlateUrlOfLatestByName = getPlateUrlOfLatestByName;

...
/**
 * 根据type（slice的name和reducerName组成）创建actionCreator
 * @param {*} type 
 * @param {*} prepareAction 
 * @returns 
 */
 ...
 * DONE
 * @param {*} initialState 
 * @param {*} mapOrBuilderCallback 
 * @param {*} actionMatchers 
 * @param {*} defaultCaseReducer 
 * @returns 
 */
    ...
    if (true) {
        if (typeof mapOrBuilderCallback === "object") {
            if (!hasWarnedAboutObjectNotation) {
                ...
                console.warn("The object notation for `createReducer` is deprecated, and will be removed in RTK 2.0. "
...
// DONE 组合slice的name和reducer的name
...
function createSlice(options) {
    ...
    function buildReducer() {
        if (true) {
            if (typeof options.extraReducers === "object") {
                if (!hasWarnedAboutObjectNotation2) {
                    ...
                    console.warn("The object notation for `createSlice.extraReducers` is deprecated,"
        ...
        const [extraReducers = {}, actionMatchers = [], defaultCaseReducer = void 0] = typeof options.extraReducers === "function"
                ...
                if (true) {
                    if (!displayedWarning) {
                        ...
                        console.info(`This platform does not implement AbortController. 
                                    If you want to use the AbortController to react to \`abort\` events,
                                    please consider importing a polyfill like

(function (global, factory) {
    ...
    //DONE React.useSyncExternalStore
    var useSyncExternalStoreShim_development = createCommonjsModule(function (module, exports) {

        {
            (function () {
                    ...
                    getServerSnapshot) {
                    {
                        if (!didWarnOld18Alpha) {
                            if (React.startTransition !== undefined) {
                                ...
                                error('You are using an outdated, pre-release alpha of React 18 that '
                ...
                var canUseDOM = !!(typeof window !== 'undefined' && typeof window.document !== 'undefined'
    ...
    var withSelector_development = createCommonjsModule(function (module, exports) {

        {
            (function () {
                 ...
                 * @param {*} subscribe  addNestedSub
                 * @param {*} getSnapshot  getState
                 * @param {*} getServerSnapshot  getState
                 * @param {*} selector selector fn
                 * @param {*} isEqual 
                 * @returns 
                 */
                function useSyncExternalStoreWithSelector(subscribe, getSnapshot, getServerSnapshot, selector, isEqual) {
                    ...
                    var _useMemo = useMemo(function () {
                        ...
                        /**
                         * 从store的最新的state中获取给定selector的返回值，尽量用缓存的值
                         * @param {*} nextSnapshot 最新的store中的state
                         * @returns 
                         */
                        var memoizedSelector = function (nextSnapshot) {
                            if (!hasMemo) {
                                ...
                                hasMemo = true;
                                memoizedSnapshot = nextSnapshot;//store中上次的值的快照

                                var _nextSelection = selector(nextSnapshot);//执行selector函数获取到用户关心的值
    ...
    function createSelectorHook(context = ReactReduxContext) {
        ...
        return function useSelector(selector, equalityFn = refEquality) {
            ...
            const selectedState = useSyncExternalStoreWithSelector(subscription.addNestedSub, store.getState, getServerState
            ...
            (function () {
                ...
                function isValidElementType(type) {
                    return typeof type === 'string' || typeof type === 'function' ||
                        ...
                        type === REACT_FRAGMENT_TYPE || type === REACT_CONCURRENT_MODE_TYPE || type === REACT_PROFILER_TYPE
                        || type === REACT_STRICT_MODE_TYPE || type === REACT_SUSPENSE_TYPE || type === REACT_SUSPENSE_LIST_TYPE
                        || typeof type === 'object' && type !== null && (type.$$typeof === REACT_LAZY_TYPE
                            || type.$$typeof === REACT_MEMO_TYPE || type.$$typeof === REACT_PROVIDER_TYPE
                            || type.$$typeof === REACT_CONTEXT_TYPE || type.$$typeof === REACT_FORWARD_REF_TYPE
                            || type.$$typeof === REACT_FUNDAMENTAL_TYPE || type.$$typeof === REACT_RESPONDER_TYPE
                            || type.$$typeof === REACT_SCOPE_TYPE || type.$$typeof === REACT_BLOCK_TYPE);
                }
                ...
                function isAsyncMode(object) {
                    {
                        if (!hasWarnedAboutDeprecatedIsAsyncMode) {
                            ...
                            console['warn']('The ReactIs.isAsyncMode() alias has been deprecated, '
        ...
        if (typeof sourceComponent !== 'string') {
            ...
            for (var i = 0; i < keys.length; ++i) {
                ...
                if (!KNOWN_STATICS[key] && !(blacklist && blacklist[key]) && !(sourceStatics && sourceStatics[key])
                    ...
                    //Function  Symbol(Symbol.hasInstance)/call/apply/bind
    ...
    // DONE Attempts to stringify whatever not-really-a-component value we were given for logging in an error message
    ...
    function subscribeUpdates(shouldHandleStateChanges, store, subscription, childPropsSelector, lastWrapperProps, lastChildProps,
        renderIsScheduled, isMounted, childPropsFromStoreUpdate, notifyNestedSubs, // forceComponentUpdateDispatch: React.Dispatch<any>,
            ...
            function ConnectFunction(props) {
                ...
                const ContextToUse = React.useMemo(() => {
                    ...
                    return propsContext && propsContext.Consumer &&
                        reactIs.isContextConsumer(React__default['default'].createElement(propsContext.Consumer, null)) ? propsContext : Context;
                ...
                const subscribeForReact = React.useMemo(() => {
                    const subscribe = reactListener => {
                        ...
                        return subscribeUpdates(shouldHandleStateChanges, store, subscription,
                            ...
                            childPropsFromStoreUpdate, notifyNestedSubs, reactListener);
                    };
    ...
    function Provider({
        ...
        //'AnyAction' is assignable（可分配的） to the constraint of type 'A', but 'A' could be instantiated with a different subtype
